...
# NO SPACES!!!
toplevelname="uart_top"
designfile="design/uart_rx.sv design/uart_top.sv design/uart_tx.sv" #ADD ALL DESIGN FILES
testbench="test_benches/uart_top_testbench.sv"
