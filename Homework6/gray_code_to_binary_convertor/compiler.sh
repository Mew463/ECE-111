...
# NO SPACES!!!
toplevelname="gray_code_to_binary_convertor"
designfile="gray_code_to_binary_convertor.sv" #ADD ALL DESIGN FILES
testbench="gray_code_to_binary_convertor_testbench.sv"
