...
# NO SPACES!!!
top_level_file="Part_2_others/2.d.sv"
# top_level_file="viterbi_top_level/viterbi_tx_rx_clean.sv"

toplevelname="viterbi_tx_rx"
designfile="ACS.sv bmc_modules.sv decoder.sv encoder.sv mem_1x1024.sv mem_8x1024.sv tbu.sv" #ADD ALL DESIGN FILES
testbench="viterbi_tx_rx_tb.sv"

arg1=$1

if [ "$arg1" = "sim" ]; then
    iverilog -g2012 -o $toplevelname.vvp $designfile $top_level_file $testbench
